...
int main()
{
    ...
    while (tc--)
    {
        ...
        lli min = *min_element(arr.begin(), arr.end());
        ...
        // }
        // else if (min == 0)
        //     cout << 0 << " " << pow(max, 2) << endl;
        // else if (max == 0)
        //     cout << 0 << " " << pow(min, 2) << endl;

        // else if (max > 0 && min > 0)
        // {
        //     cout << pow(min, 2) << " " << pow(max, 2) << endl;
        // }
        // else if (max > 0 && min < 0)
        // {
        //     if (abs(max) >= abs(min))
        //         cout << max * min << " " << pow(max, 2) << endl;
        //     else
        //         cout << max * min << " " << pow(min, 2) << endl;
        // }
        // else if (max < 0 && min < 0)
        // {
        //     cout << pow(max, 2) << " " << pow(min, 2) << endl;
        // }
